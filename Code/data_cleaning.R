...
# 26
business_bars_cleaned[1:5,c(14, 26 ,28, 29, 30 ,32)]
...
good_variables = good_variables[-1]
...
loit_mod2_0.5 = glm(as.factor(stars)~.,business_bars_cleaned[good_obs,good_variables],
